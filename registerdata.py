...
class Registerdata(Screen):
    ...
    def build(self):
        builder.load_file('registerdata.kv')
    def save_data(self):
    ...
    def on_press(malebtn):
            popupWindow.open()
    #make sure documentation of diagnosis is official
    def officialbtn(MDFlatButton):
        MDFlatButton.notofficialbtn = 'notofficialbtn'
    def on_press(notofficialbtn):
            popupWindow.open()
